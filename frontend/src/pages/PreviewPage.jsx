      ...
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-lg p-6 sm:p-8 lg:p-10">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-500 mt-1">
              Your final framed photobooth image is ready to download, upload, or share.
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="flex flex-col gap-4">
            {finalImage ? (
              <div className="border border-slate-200 rounded-2xl p-4 bg-white shadow-sm">
                <p className="text-xs text-slate-500 mb-3">Final Instagram Story frame</p>
                <img
                  src={finalImage}
              ...
              <p className="text-xs text-slate-500">No image loaded. Returning to capture...</p>
            )}
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* Step 1: Cloud Upload */}
            <div className="border border-slate-200 rounded-2xl p-4 bg-white shadow-sm">
              <p className="text-xs text-slate-500 mb-3">Step 1: Upload to Cloud</p>
              <button
                type="button"
              ...
              {uploadUrl && (
                <p className="text-[11px] text-slate-500 mt-2 break-all">
                  Uploaded URL: <span className="text-slate-700">{uploadUrl}</span>
                </p>
              )}
            </div>
            ...
            {/* Step 2: Email */}
            <div className="border border-slate-200 rounded-2xl p-4 bg-white shadow-sm">
              <p className="text-xs text-slate-500 mb-3">Step 2: Send to Email</p>
              <input
                type="email"
            ...
            {uploadUrl && (
              <div className="border border-slate-200 rounded-2xl p-4 bg-white shadow-sm mt-2">
                <p className="text-xs text-slate-500 mb-3">Step 3: Scan to Download</p>
                ...
                <p className="text-[11px] text-slate-500 mt-3 text-center">
                  Scan the QR to open and save the final photo.
                </p>
              </div>
            )}

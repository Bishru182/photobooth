...
function CapturePage() {
  ...
  const handleNext = () => {
    ...
    // 👉 Option A: pass data via React Router state
    navigate("/preview", {
      state: {
        finalImage,
        photos,
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-[11px] text-slate-400">
              Tip: Make sure the faces are clearly visible in each photo. Once all
              3 are captured, we&apos;ll automatically place them into your custom
              frame. The next step is uploading this final image.
            </p>
          </div>
        </div>
      </div>
